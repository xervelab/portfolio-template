...
export default function Header({ profile, onInquireClick, onAddPostClick }: HeaderProps) {
  ...
  return (
    <header className="py-6 sm:py-10 md:py-14 border-b border-neutral-200 dark:border-white/10 transition-colors duration-300 overflow-x-hidden" id="artist-profile-header">
