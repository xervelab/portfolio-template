...
export default function App() {
  ...
  return (
    <div id="app-root-container" className="overflow-x-hidden w-full max-w-full">
      
      {/* Background Wrapper */}
      <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0A0A0A] text-neutral-900 dark:text-[#E5E5E5] flex flex-col font-sans transition-colors duration-300 overflow-x-hidden">
        ...
        {/* Sticky footer bar */}
        <footer className="fixed bottom-0 left-0 right-0 z-20 py-3 sm:py-4 px-4 bg-neutral-100/95 dark:bg-[#060606]/95 backdrop-blur-md border-t border-neutral-200 dark:border-white/5 text-center space-y-1.5 select-none font-sans transition-colors duration-300">
          <div className="flex items-center justify-center gap-2 text-brand-gold/60">
            <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-brand-gold animate-pulse" />
            <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] font-medium">Elena Rostova Studio</span>
          </div>
          <p className="text-[9px] sm:text-[10px] text-neutral-500 dark:text-zinc-500 font-serif italic tracking-wide">
            © 2026 Elena Rostova. Co-represented globally by Galerie de l'Élysée, Paris.
          </p>
          <p className="text-[8px] sm:text-[9px] text-neutral-400 dark:text-neutral-600 font-mono uppercase tracking-[0.18em]">
            Powered by 
            <a href="https://xervelab.online" className="ml-1 sm:ml-2 underline decoration-dotted" target="_blank" rel="noopener noreferrer">XerveLab Online</a>
          </p>
        </footer>
